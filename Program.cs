...
public static class Program
{
    public static async Task Main()
    {
        ...
        await toolManager.LoadToolsAsync(settings.ToolsPath, "*.cs", cancellationTokenSource.Token);
        ...
        Orchestrator orchestrator = new(chatClient, toolManager, sessionStore, eventBroker, branchSquasher, circuitBreaker);
